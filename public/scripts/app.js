    ...
    let $tweet =
        ...
        .append($("<header>")
          .append($(`<div class='avatar'>`)
            .append($(`<img class='profile-picture' src='${escape(tweetData.user.avatars.regular)}'>`)
            )
            .append($(`<h2 class='profile-name'>${escape(tweetData.user.name)}</h2>`)
            )
          )
          .append($("</div>")
          )
          .append($(`<span class='handle'>${escape(tweetData.user.handle)}</span>`)
          )
        )
        .append($("</header>")
        )
